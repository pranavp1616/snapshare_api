...
INSTALLED_APPS = [
    ...
    'storages', # For Django to store image/mediafiles in AWS S3 bucket
]
...
#config for postgres database on Heroku server
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # For Heroku config 
STATIC_URL = '/static/'
